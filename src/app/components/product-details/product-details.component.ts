...
export class ProductDetailsComponent implements OnInit{
  ...
  constructor(private _activatedRoute:ActivatedRoute, private _getDataService:GetDataService,private _DataStorageService:DataStorageService,private _router:Router){}
  ngOnInit(){
